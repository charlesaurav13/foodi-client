...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li tabIndex={0}>
        {/* <details>
          <summary className={`text-${isDarkMode ? 'dark' : 'gray'}`}>Menu</summary>
        ...
        <a href="/menu" className="text-gray">Menu</a>
      </li>
      <li tabIndex={0}>
      </li>
    </>
    ...
    >
      <div
        className={`navbar xl:px-24 ${
          isSticky
            ? "shadow-md bg-gray-100 transition-all duration-300 ease-in-out text-black"
            : ""
        }`}
      >
