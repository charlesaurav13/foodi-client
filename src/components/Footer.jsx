    ...
    <div>
      <footer className={`footer xl:px-24 py-10 px-4 text-base-content ${
        ...
        <aside>
          ...
          Kahin bhi khana, apne ghar jaisa
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">anywherethali@gmail.com</a>
          <a className="link link-hover">+918375800427</a>
      ...
      <footer  className={`footer items-center xl:px-24 px-4 py-4 mt-2 ${
        ...
        <aside className="items-center grid-flow-col">
          <p>© Copyright Anywhere Thali. All Rights Reserved</p>
        </aside>
